...
<v-app id="inspire">
    <v-navigation-drawer v-model="drawer" app :mobile-breakpoint="764">
        <v-list-item class="pa-0">
            <v-img
              ...
              <div class="white--text text-subtitle-1 font-weight-bold">Ananthu Krishnan</div>
    ...
    <v-app-bar app color="primary" dark src="https://picsum.photos/1920/1080?random" prominent height="172">
